<?php
  ...
  // Cierra la sesión si se accede directamente a login.php
  ...
  <div class="w-full max-w-3xl bg-white/95 border-2 border-[#51B2E0] rounded-2xl shadow-xl p-16">
    ...
    <form action="login.php" method="POST" class="flex flex-col gap-6">
      <div class="relative">
        ...
        <input type="text" id="usuario" name="usuario" required placeholder="Correo" class="pl-14 pr-4 py-4 w-full rounded-xl border-2 border-[#51B2E0] focus:border-[#51E0E0] text-lg sm:text-xl bg-[#E0FAF4] text-[#2773A5] placeholder-[#51B2E0]/60">
      </div>
      <div class="relative">
