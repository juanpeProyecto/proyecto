...
<body class="bg-gradient-to-br from-[#E0FAF4] to-[#51B2E0] flex flex-col items-center px-2 text-2xl min-h-screen justify-center">
    <div class="w-full max-w-3xl bg-white border-2 border-[#51B2E0] hover:border-[#72E8AC] rounded-2xl shadow-xl p-16">
        <form action="guardarAnadirEmpleado.php" method="POST" class="flex flex-col gap-6">
            ...
            <button type="submit" class="w-full flex flex-row items-center justify-center gap-2 bg-[#72E8AC] hover:bg-[#72E884] text-[#256353] hover:text-white transition-all duration-200 px-8 py-4 rounded font-bold text-xl text-center border-2 border-[#72E884] mt-6 cursor-pointer">Añadir Empleado</button>
