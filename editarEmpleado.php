<?php
    ...
    $codEmpleado = intval($_GET['codEmpleado']);//hago un casting a entero
        ...
        <form action="guardarEditarEmpleado.php" method="POST" class="flex flex-col gap-6">
            ...
            <div class="">
                ...
                <select id="rol" name="rol" required class="pl-4 pr-4 py-4 w-full rounded-md border-2 border-[#51B2E0] hover:border-[#72E8AC] focus:border-[#72E8AC] focus:ring-0 outline-none focus:outline-none text-lg sm:text-xl bg-[#E0FAF4] text-[#2773A5]">
                    ...
                    <option value="administrador" <?= $emp['Rol']==='administrador' ? 'selected' : '' ?>>Administrador</option>
                    <option value="camarero" <?= $emp['Rol']==='camarero' ? 'selected' : '' ?>>Camarero</option>
                    <option value="cocinero" <?= $emp['Rol']==='cocinero' ? 'selected' : '' ?>>Cocinero</option>
                    <option value="barra" <?= $emp['Rol']==='barra' ? 'selected' : '' ?>>Barra</option>
                </select>
            </div>
